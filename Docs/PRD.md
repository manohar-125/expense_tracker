...
The Add control must be visually prominent: larger than the Home and More tab items, still clearly a labeled tab. Tapping Add opens the add-expense popup on the **current** tab (Home or More). It does not switch to a separate Add screen.
